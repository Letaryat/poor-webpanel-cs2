...
export async function GET(req) {
    try {
        ...
        if (type === "bans") {
            ...
            FROM sa_bans LEFT JOIN sa_servers ON sa_bans.server_id = sa_servers.id WHERE 
        ...
        `;
            ...
            players = await prisma.$queryRaw`
                    ...
                    FROM sa_mutes LEFT JOIN sa_servers ON sa_mutes.server_id = sa_servers.id WHERE
